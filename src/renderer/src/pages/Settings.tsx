  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="border-b bg-white px-6 py-4 dark:border-gray-700 dark:bg-gray-800">
        <button onClick={() => navigate('/courses')} className="mb-2 text-sm text-blue-500 hover:underline">
          &larr; 과목 목록
        </button>
      ...
      <div className="max-w-xl space-y-6 p-6">
        {/* 다운로드 규칙 */}
        <Section title="다운로드">
          <label className="mb-1 block text-sm text-gray-600 dark:text-gray-400">다운로드 규칙</label>
          <select
            value={downloadRule}
